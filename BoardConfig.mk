...
# Assert
TARGET_OTA_ASSERT_DEVICE := oplus_mssi_64_cn

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 14143488 # This is the maximum known partition size, but it can be higher, so we just omit it
